 ...
 */
  ...
  #if NONE(SDSUPPORT, CANFILE, SET_PROGRESS_MANUALLY)
 ...
 */
  ...
  #elif ENABLED(PARK_HEAD_ON_PAUSE) && NONE(SDSUPPORT, CANFILE, IS_NEWPANEL, EMERGENCY_PARSER)
    #error "PARK_HEAD_ON_PAUSE requires SDSUPPORT, CANFILE, EMERGENCY_PARSER, or an LCD controller."
...
#elif ENABLED(PRINTER_STATUS_LEDS) && !HAS_COLOR_LEDS
  #error "PRINTER_STATUS_LEDS requires BLINKM, PCA9533, PCA9632, RGB_LED, RGBW_LED or NEOPIXEL_LED."
...
#if BOTH(PRINTER_EVENT_LEDS, PRINTER_STATUS_LEDS)
  #error "PRINTER_EVENT_LEDS and PRINTER_STATUS_LEDS are incompatible."
#endif
 ...
 */
  ...
  + COUNT_ENABLED(DGUS_LCD_UI_CREATBOT, CREATBOT_LINUX_LCD) \
...
#if ENABLED(LED_CONTROL_MENU) && NONE(HAS_MARLINUI_MENU, DWIN_LCD_PROUI, CREATBOT_LCD)
 ...
 * CAN Bus check
*/
#if DISABLED(CANOPEN_SUPPORT)
  #if ENABLED(CANOPEN_LCD)
    #error "CANOPEN_LCD requires CANOPEN_SUPPORT"
  #endif
#endif
#if BOTH(CANFILE, HAS_MEDIA)
  #error "CANFILE and MEDIA are incompatible."
#endif
